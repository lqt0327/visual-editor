...
const validRatio = async (file, { width, height, size=1000000}) => {
  let valid = 0;
  const map = {
    0: 'success',
    1: `图片宽度应为${width}，高度应为${height}`,
    2: `图片大小不能超过${size/1000000}MB`
  }
...
export { debounce, base64Time, captureScreen, validRatio };
